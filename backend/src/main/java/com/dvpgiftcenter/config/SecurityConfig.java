...
import com.dvpgiftcenter.security.CustomUserDetailsService;
import com.dvpgiftcenter.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
            ...
            .authorizeHttpRequests(authz -> authz
                // Public endpoints - browsing and auth
                ...
                // Static uploaded assets (profile images, etc.)
